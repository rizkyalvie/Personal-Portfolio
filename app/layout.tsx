  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <div className="bg-[#dbd7fb] absolute top-[20rem] left-[11rem] h-[30rem] w-[50rem] -z-10 rounded-full blur-[5rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]" />
        <Header />
        {children}
      </body>
    </html>
